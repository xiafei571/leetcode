...
public class Subdomain3AdClick {
		/*
		 * Q3: Ad Attribution 题， 没时间写完。
		The people who buy ads on our network don't have enough data about how ads 
		are working for their business. They've asked us to find out which ads produce 
		the most purchases on their website.
		...
		then return the ad text, that ad's number of clicks, and how many of those ad clicks were from 
		users who made a purchas‍‌‍‌‌‌‍‌‌‍‌‍‍‍‍‍‌‍‌‌e.
		Expected output:
